...
func (r ApiGetDagWarningsRequest) DagId(dagId string) ApiGetDagWarningsRequest {
	r.dagId = &dagId
	return r
}
// If set, only return DAG warnings with this type.
func (r ApiGetDagWarningsRequest) WarningType(warningType string) ApiGetDagWarningsRequest {
	r.warningType = &warningType
	return r
}
// The numbers of items to return.
func (r ApiGetDagWarningsRequest) Limit(limit int32) ApiGetDagWarningsRequest {
	r.limit = &limit
	return r
}
// The number of items to skip before starting to collect the result set.
func (r ApiGetDagWarningsRequest) Offset(offset int32) ApiGetDagWarningsRequest {
	r.offset = &offset
	return r
}
// The name of the field to order the results by. Prefix a field name with &#x60;-&#x60; to reverse the sort order.  *New in version 2.1.0* 
func (r ApiGetDagWarningsRequest) OrderBy(orderBy string) ApiGetDagWarningsRequest {
	r.orderBy = &orderBy
	return r
}
