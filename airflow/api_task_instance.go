...
func (r ApiSetMappedTaskInstanceNoteRequest) Execute() (TaskInstance, *_nethttp.Response, error) {
...
*/
func (a *TaskInstanceApiService) SetMappedTaskInstanceNote(ctx _context.Context, dagId string, dagRunId string, taskId string, mapIndex int32) ApiSetMappedTaskInstanceNoteRequest {
	return ApiSetMappedTaskInstanceNoteRequest{
		ApiService: a,
		ctx: ctx,
		dagId: dagId,
...
// Execute executes the request
//  @return TaskInstance
func (a *TaskInstanceApiService) SetMappedTaskInstanceNoteExecute(r ApiSetMappedTaskInstanceNoteRequest) (TaskInstance, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiSetTaskInstanceNoteRequest) Execute() (TaskInstance, *_nethttp.Response, error) {
...
*/
func (a *TaskInstanceApiService) SetTaskInstanceNote(ctx _context.Context, dagId string, dagRunId string, taskId string) ApiSetTaskInstanceNoteRequest {
	return ApiSetTaskInstanceNoteRequest{
		ApiService: a,
		ctx: ctx,
		dagId: dagId,
...
// Execute executes the request
//  @return TaskInstance
func (a *TaskInstanceApiService) SetTaskInstanceNoteExecute(r ApiSetTaskInstanceNoteRequest) (TaskInstance, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
