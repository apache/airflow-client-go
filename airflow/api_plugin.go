...
func (r ApiGetPluginsRequest) Execute() (*PluginCollection, *http.Response, error) {
...
func (a *PluginApiService) GetPluginsExecute(r ApiGetPluginsRequest) (*PluginCollection, *http.Response, error) {
	var (
